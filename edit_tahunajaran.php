    ...
    <div class="row">
      <div class="col-12">
        <form method="post" action="">
          <input type="hidden" name="idtahunajaran" value="<?php echo $e['idtahunajaran']; ?>" required />
          <table class="table">
            <tr>
              <td>Tahun Ajaran</td>
              <td><input type="text" class="form-control" name="tahunajaran" value="<?php echo $e['tahunajaran']; ?>" required /></td>
            </tr>
            <tr>
              <td></td>
